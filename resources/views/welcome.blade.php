        ...
        <section id="about">
            <div class="container">
                ...
                <header class="section-header">
                    <h3>About Us</h3>
                    <p>We Are An Innovative Investments That Registered companies act No.07 of 2007 of Sri Lanka,
                        Company Registration No. P B 5311 As a Limited Liability Company In Sri Lanka. MICRO CREDIT
                        LIMITED.</p>
                </header>
                ...
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 content order-lg-1 order-2">
                        <p>
                            First the company was registered in 2019 as “ Madhushanka MicroCredit(pvt)LTD” under the
                        ...
                        <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <p class="description">Company Registration No. P B 5311 As a Limited Liability Company In
                                Sri Lanka</p>
                        </div>
                ...
                <div class="row about-extra">
                    ...
                    <div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0">
                        <h4>Vision</h4>
                        <p>
                            We believe in an inclusive financial service that requires client advocacy and stewardship,
                            a passion for leading-edge solutions and the delivery of services that exceed customer
                            expectations.
                        </p>
                ...
                <div class="row about-extra">
                    ...
                    <div class="col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1">
                        <h4>Mission</h4>
                        <p>
                            Our mission is to help set the industry standard in Non-Bank Financial Services. We reach
                            out to all Small and Medium Enterprises and provide them with affordable and convenient
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-gampaha">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>App</p>
                                <div>
                                    <a href="rom_pics\land1.jpg" data-lightbox="portfolio" data-title="App 1"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-Kaluthara" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>Web</p>
                                <div>
                                    <a href="rom_pics\land2.jpg" class="link-preview" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-gampaha" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>App</p>
                                <div>
                                    <a href="rom_pics\land3.jpg" class="link-preview" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-Colombo">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>Card</p>
                                <div>
                                    <a href="rom_pics\land4.jpg" class="link-preview" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-Kaluthara" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>Web</p>
                                <div>
                                    <a href="rom_pics\land5.jpg" class="link-preview" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-gampaha" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>App</p>
                                <div>
                                    <a href="rom_pics\land6.jpg" class="link-preview" data-lightbox="portfolio"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp">
                        <div class="member">
                            <img src="{{URL::asset('/storage/OwnerPhotos/'.$director['Photo'])}}" class="img-fluid"
                            ...
                            <div class="member-info">
                                <div class="member-info-content">
                                    ...
                                    <div class="social">
                                        <a href="{{$director->twitter}}" target="_blank"><i
                                                class="fa fa-twitter"></i></a>
                                        <a href="{{$director->facebook}}" target="_blank"><i
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <a href="{{$client->url}}"><img
                                    src="{{URL::asset('/storage/ClientsLogos/'.$client['Photo'])}}" class="img-fluid"
                                    alt=""></a>
                        </div>
                    </div>
                    @endif
    ...
    <footer id="footer">
        ...
        <div class="container">
            <footer class="main-footer text-center">
                <strong>Copyright &copy; 2020 <a href="/home" style="color:white;">Madhushanka
