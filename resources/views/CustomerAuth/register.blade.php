    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/registerCus" class ="form-group">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="name2" class="col-md-4 col-form-label text-md-right">{{ __('Name With Initials ') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group">
                                ...
                                <input id="nic" type="number" class="form-control @error('nic') is-invalid @enderror" name="nic" value="{{ old('nic') }}" placeholder="123456789 / 123456789012" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12">
