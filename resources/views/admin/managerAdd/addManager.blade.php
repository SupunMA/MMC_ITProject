...
<div class="content-header">
  ...
  <div class="card-header">{{ __('ENTER ADMIN DETAILS') }}</div>
  <div class="card-body">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" placeholder="Branch Address" value="" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="validationCustomUsername" placeholder="Telephone" aria-describedby="inputGroupPrepend" required>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" placeholder="Paste Link Here" required>
      <div class="invalid-feedback">
