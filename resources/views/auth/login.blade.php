      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"><img src="{{ asset('img/atwork.gif') }}" width="500" height="500"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  @csrf
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block swalDefaultSuccess">
                      Login
                      </button>
...
@if (Route::has('registerCus'))
                  ...
                  <a class="btn btn-warning btn-lg btn-block" type="button" href="{{ route('register') }}">{{ __('Register') }}</a>
