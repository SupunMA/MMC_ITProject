...
<body style="background: linear-gradient(48deg, rgba(2,0,36,1) 0%, rgba(8,8,154,1) 0%, rgba(213,33,244,1) 85%);">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-black shadow-sm" style="background: linear-gradient(48deg, rgba(255,255,255,0.6923144257703081) 100%, rgba(255,255,255,0.38139005602240894) 100%, rgba(255,255,255,0) 100%);">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto ">
                            ...
                            <a href="{{ route('login') }}" type="button" class="btn btn-outline-primary active" >Company Login</a> {!! "&nbsp;" !!}
                            <a href="{{ route('loginCus') }}" type="button" class="btn btn-outline-primary"  >Customer Login</a>
