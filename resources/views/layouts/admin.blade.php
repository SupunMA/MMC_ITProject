...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light ">
    ...
    <li>
    <iframe src="http://free.timeanddate.com/clock/i7hugwpa/n1925/fn17/fs12/ftb/bts0/bbs0/tt0/tw1/tm1/tb4" frameborder="0" width="134" height="32"></iframe>
    </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/adminAddBranch" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Branch Details</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/adminAddClient" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Client Details</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/adminAddOwner" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Owner Details</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/adminDetails" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Admin Details</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/managerDetails" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manager Details</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/customerDetails" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/composeAdmin" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Compose</p>
                </a>
              </li>
